...
export default function ProductModal({ product, onClose }) {
  ...
  const mainImg = getOptimizedUrl(product?.images?.[selectedImage], 800)
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        />
        <motion.div
          className="relative w-full max-w-4xl max-h-[90vh] bg-carbon border border-white/10 rounded-3xl overflow-hidden flex flex-col lg:flex-row"
          ...
          <div className="lg:w-2/5 p-6 lg:p-8 flex flex-col justify-between">
            ...
            <div className="mt-6 space-y-3">
              <motion.button
                ...
                disabled={clicked}
                className="w-full py-3 px-6 rounded-xl bg-primary hover:bg-primary-dark text-white font-medium transition-all disabled:opacity-50"
